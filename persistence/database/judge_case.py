...
async def batch_get_with_judgment(testcase_id: int, judgment_ids: Iterable[int], verdict: enum.VerdictType = None) -> dict[int, do.JudgeCase]:
    ...
    async with FetchAll(
            ...
            sql=fr'SELECT judge_case.judgment_id, judge_case.testcase_id, judge_case.verdict, '
                ...
                fr"        AND judge_case.verdict = '{verdict}'" if verdict  else "",
